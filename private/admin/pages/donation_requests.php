...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
  <div class="wrapper" data-csrf-token="<?= e($csrfToken) ?>">
      ...
      <div class="content">
        <div class="container-fluid pb-1">
          <div class="card shadow-sm">
            <div id="donation-container" class="card-body" data-status="pending">
  ...
  <script src="../../assets/admin/js/donations/donation_requests.js"></script>
</body>
