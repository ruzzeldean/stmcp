...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="./" class="brand-link">
    ...
    <span class="brand-text font-weight-light"><?= e($role === 4 ? 'MEMBER' : 'ASPIRANT') ?> | STMCP</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="./my_profile.php" class="nav-link <?= e($currentPage === 'my_profile.php' || $currentPage === 'edit_profile.php' ? 'active' : '') ?>">
        ...
        <li class="nav-item">
          <a href="./my_account.php" class="nav-link <?= e($currentPage === 'my_account.php' || $currentPage === 'edit_account.php' ? 'active' : '') ?>">
        ...
        <li class="nav-item">
          <a href="./announcements.php" class="nav-link <?= e($currentPage === 'announcements.php' ? 'active' : '') ?>">
