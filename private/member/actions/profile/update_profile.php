...
try {
  ...
  if ($update->rowCount() > 0) {
    ...
    if ($check) {
      ...
      sendResponse('error', 'No person found with the ID provided');
    }
  }
} catch (Throwable $e) {
  error_log('Failed updating profile: ' . $e);
  sendResponse('error', 'An error occured while updating your profile. Please try again later');
}
